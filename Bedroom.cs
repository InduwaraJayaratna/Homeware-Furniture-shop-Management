...
namespace CODSE22F_023
{
    public partial class Bedroom : Form
    {
        ...
        private void add_Click(object sender, EventArgs e)
        {
            ...
            {
                pay.Visible = true;
                cmd3 = new SqlCommand("INSERT INTO Orders (CName, email, Prod_Name, Total)VALUES('" + textBox1.Text + "','" + Login.email + "','" + comboBox1.Text + "'," + total.Text + ")", con);
        ...
        private void Bedroom_Load(object sender, EventArgs e)
        {
            ...
            if (dt1.Rows.Count > 0)
            {
                username = dt1.Rows[0]["CName"].ToString();
